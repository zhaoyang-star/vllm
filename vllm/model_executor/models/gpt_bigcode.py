...
class GPTBigCodeAttention(nn.Module):
    ...
    def __init__(self, config: GPTBigCodeConfig):
        ...
        self.c_attn = ColumnParallelLinear(self.hidden_size,
                                           self.hidden_size + 2 * self.kv_dim * self.tensor_model_parallel_world_size,
                                           bias=True,
                                           gather_output=False,
    ...
    def load_weights(self,
        ...
        for name, loaded_weight in hf_model_weights_iterator(
            ...
            if "c_attn" in name:
                ...
                # For multi-head attention, we split the query/key/value heads, while for multi-query
                # attention we split the query heads but replicae the key and value heads.
